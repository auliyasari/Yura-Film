                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><b>Actors: </b>${detail.Actors}</li>
                                <li class="list-group-item"><b>Writer: </b>${detail.Writer}</li>
                                <li class="list-group-item"><b>Plot: </b>${detail.Plot}</li>
                            </ul>
                        </div>
                    </div>
                </div>
